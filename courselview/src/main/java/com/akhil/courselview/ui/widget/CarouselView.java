package com.akhil.courselview.ui.widget;
...
import com.akhil.courselview.ui.transformer.CoverFlowViewTransformer;
import com.akhil.courselview.ui.transformer.InverseTimeMachineViewTransformer;
import com.akhil.courselview.ui.transformer.LinearViewTransformer;
import com.akhil.courselview.ui.transformer.ParameterizedViewTransformer;
import com.akhil.courselview.ui.transformer.TimeMachineViewTransformer;
import com.akhil.courselview.ui.transformer.WheelViewTransformer;
...
//		}
	...
	public void setDisplayMode(DisplayMode mode) {
		switch (mode) {
			...
			case Horizontal:
				setTransformerInternal((ViewTransformer) new LinearViewTransformer());
				break;

			case Wheel:
				setTransformerInternal((ViewTransformer) new WheelViewTransformer());
				break;

			case CoverFlow:
				setTransformerInternal((ViewTransformer) new CoverFlowViewTransformer());
				break;

			case TimeMachine:
				setTransformerInternal((ViewTransformer) new TimeMachineViewTransformer());
				break;
			...
			case Parameterized:
				setTransformerInternal((ViewTransformer) new ParameterizedViewTransformer());
				break;
