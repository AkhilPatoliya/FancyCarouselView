package com.akhilpatoliya.fancycourselview;
...
import com.akhilpatoliya.fancycourselview.ui.ConfigRowLayout;
import com.akhilpatoliya.fancycourselview.util.Metrics;
...
public class ConfigFragment extends Fragment {
	...
	@BindView(R.id.spnTransformer)
    Spinner spnTransformer;
	@BindView(R.id.spnDrawOrder)
    Spinner spnDrawOrder;
	@BindView(R.id.swhIsInfinite)
    Switch swhIsInfinite;
	@BindView(R.id.swhIsScrollingAlignToViews)
    Switch swhIsScrollingAlignToViews;
	@BindView(R.id.swhIsClipChildren)
    Switch swhIsClipChildren;
	@BindView(R.id.sekItems)
    SeekBar sekItems;
	@BindView(R.id.sekExtraChilds)
    SeekBar sekExtraChilds;
	@BindView(R.id.sekItemWidth)
    SeekBar sekItemWidth;
	@BindView(R.id.sekItemHeight)
    SeekBar sekItemHeight;
	@BindView(R.id.spnGravity)
    Spinner spnGravity;
	@BindView(R.id.spnLayoutWidth)
    Spinner spnLayoutWidth;
	@BindView(R.id.spnLayoutHeight)
    Spinner spnLayoutHeight;
	@BindView(R.id.rcvTransformerParameters) RecyclerView rcvTransformerParameters;
	@BindView(R.id.tabPanel) TabLayout tabPanel;
	ConfigRecyclerAdapter mConfigRecyclerAdapter;
	@BindViews({R.id.sekItems, R.id.sekExtraChilds, R.id.sekItemWidth, R.id.sekItemHeight})
